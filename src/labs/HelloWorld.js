...
const HelloWorld = () => (
  <>
    <Section>
      <Section.title>
        Синтаксис, подключение скриптов
      </Section.title>
      <Section.text>
        <b>Цель:</b>
        изучить основные понятия JavaScript,
        научиться работать с внешними файлами.
      </Section.text>
      ...
      <Section.divider />
      <Section.text>
        Рабочая среда для запуска наших скриптов - браузер.
      </Section.text>
      <Section.text>
        Сначала посмотрим, как выполнить скрипт на странице.
